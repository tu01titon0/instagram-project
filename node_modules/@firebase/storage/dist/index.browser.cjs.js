...
function factory(container, _a) {
    ...
    var storageServiceCompat = new StorageServiceCompat(app, new FirebaseStorageImpl(app, authProvider, appCheckProvider, new ConnectionPool(), url, firebase__default['default'].SDK_VERSION));
    return storageServiceCompat;
}
